...
public class PostQQLoginInfoTask extends CustomPostExecuteAsyncTask<LoginAccountInfo, Void, LoginResponse> {
    private OkHttpClient okHttpClient;

    public PostQQLoginInfoTask(TaskPostExecuteWrapper<LoginResponse> DoInPostExecute) {
    ...
    public LoginResponse doInBackground(LoginAccountInfo... loginAccountInfos) {
        try {
            ...
            String afterEncryption = otokatariAndroidApplication.RSAUtilsEncrypt(loginAccountInfos[0].getCredentials());
