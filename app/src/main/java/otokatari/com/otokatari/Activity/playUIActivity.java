...
import otokatari.com.otokatari.View.BackgourndAnimationRelativeLayout;
import otokatari.com.otokatari.View.DiscView;
import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;
import static otokatari.com.otokatari.View.DiscView.DURATION_NEEDLE_ANIAMTOR;
...
public class playUIActivity extends AppCompatActivity implements DiscView.IPlayInfo, View
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMusicDatas(play_url,song_name,author_name);
        initView();
        initMusicReceiver();
    ...
    private void initMusicDatas(String play_url,String song_name,String author_name) {
//
        MusicData musicData1=new MusicData(play_url,R.drawable.xue,song_name,author_name);
...
//
    ...
    private Drawable getForegroundDrawable(int musicPicRes) {
        ...
        final float widthHeightSize = (float) (DisplayUtil.getScreenWidth(playUIActivity.this)
