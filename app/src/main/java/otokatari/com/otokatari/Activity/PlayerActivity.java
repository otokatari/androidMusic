...
import otokatari.com.otokatari.View.Player.MusicDiscPager;
...
//                ResetDiscRotation(MusicPlaylistPager.getCurrentItem());
    ...
    private void LoadMusicPages()
    {
        ...
        MusicInfo SingleMusicInfo = (MusicInfo) getIntent().getSerializableExtra("MusicInfo");
        if(SingleMusicInfo != null)
        {
            MusicInfoList.add(SingleMusicInfo);
